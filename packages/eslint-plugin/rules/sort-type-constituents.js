/**
 * 参考：https://github.com/typescript-eslint/typescript-eslint/blob/main/packages/eslint-plugin/src/rules/sort-type-constituents.ts
 * 修改的原因：https://github.com/typescript-eslint/typescript-eslint/issues/7614
 */
...
module.exports = {
    ...
    create(context) {
        const checkIntersections = true;
        const checkUnions = true;
        const groupOrder = [
            Group.named,
            Group.keyword,
            Group.operator,
